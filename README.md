![Hwllo World!](https://readme-typing-svg.demolab.com/?lines=print("Hello+World!");Console.WriteLine("Hello+World!");printf("Hello+World!"); std::cout+"Hello+World!";console.log("Hello+World!");echo+"Hello+World!";print+"Hello+World!";println!("Hello+World!");DISPLAY+"Hello+World!";printIn("Hello+World!"))
---
